...
becomes /usr/lib/fan-control-kde/pyside6, or the same path in the AppImage.
...
CACHE = Path(os.environ.get("XDG_CACHE_HOME") or Path.home() / ".cache") / "fan-control-kde-build"
...
Comment:
 ...
 plugins Fan Control KDE does not use left out:
{wheels}
